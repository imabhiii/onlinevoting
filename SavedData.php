...
<center>
 ...
 include("dbConnect.php");
                if (isset($_GET['Party'])) {
                    ...
                    $select = "select * from candidates where name='$PartyVote'";
                    $run = mysqli_query($connect, $select);
                ...
                <form action="" method="POST"><br>
                    ...
                    <a href="primeMinister_Candidate.php" class="btn btn-warning">cancel</a>
                </form>
               ...
               include("dbConnect.php");
                if (isset($_POST['submit'])) {
                    ...
                    $eVotess = $eVotess + 1;
                    $update = "update candidates set Votess='$eVotess' where name='$PartyVote'";
                    ...
                    include("dbConnect.php");
                    $Rupdate = "update users set Votes='YES' where name='$name'";
