...
<center>
 ...
 include("dbConnect.php");
                if (isset($_GET['Party'])) {
                    ...
                    $select = "select * from candidate2nd where name='$PartyVote'";
                    $run = mysqli_query($connect, $select);
                ...
                <form action="" method="POST"><br>
                    ...
                    <a href="EducationMinister_candidate.php" class="btn btn-warning">cancel</a>
                </form>
               ...
               include("dbConnect.php");
                if (isset($_POST['submit'])) {
                    ...
                    $eVotess = $eVotess + 1;
                    $update = "update candidate2nd set Votess='$eVotess' where name='$PartyVote'";
                    ...
                    include("dbConnect.php");
                    $Rupdate = "update users set votes2='YES' where name='$name'";
