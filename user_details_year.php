        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 d-flex justify-content-center align-items-center">
                    <a href="user_details.php"><button class="btn-special mt-5">Prime
                            Minister</button></a>
                </div>
                <div class="col-md-12 d-flex justify-content-center align-items-center">
                    <a href="user_details_2.php"><button class="btn-special mt-5">President</button></a>
                </div>
                <div class="col-md-12 d-flex justify-content-center align-items-center">
                    <a href="user_details_3.php"><button class="btn-special mt-5">Education
                            Minister</button></a>
                </div>
            </div>
        </div>
