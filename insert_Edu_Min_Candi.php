...
$insert="INSERT INTO `candidate2nd`(`name`, `email`, `mobile`, `enrollid`, `photo`, `Bio`,`Votess`) VALUES ('$name','$email','$mobile','$enrollid','$image','$Bio',0)";
...
<head>
    ...
    <title>insert Education candidate</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                ...
                <p style="padding-top:10px; font-weight:bold;">Education Minister Enroll</p>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="padding-top: 20px; padding-bottom: 40px;"><button class="btn btn-primary"
                                    name="add_electionE">Submit</button></td>
                        </tr>
                    </table>
                </form>
            </div>
