...
<head>
    ...
    <title>PrimeMinisterVotingPage</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-center" style="padding-top:10px;color: White; font-weight:bold;">Prime Minister candidate</p>
            </div>
...
<div class="col-md-3" style="margin-left: 45px;">
                ...
                <a href="SavedData.php"><img class="card-img-top"src="<?php echo "img/".$row1['photo'];
                ...
                <div class="card-body">
                        ...
                        <h2 class="card-title"> <a href="SavedData.php?Party=<?php echo $row1['name']; ?>" class="btn btn-primary">Vote</a></h2>
                </div>
            </div>
        </div>
    <!-- </div> -->
