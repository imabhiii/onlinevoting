...
<head>
    ...
    <title>EducationMinisterVotingPage</title>
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p class="text-center" style="padding-top:10px; color:white; font-weight:bold;">Education Minister candidate</p>
            </div>
            <?php include("dbConnect.php");?>
               ...
               <?php
                include("dbConnect.php");
                    ...
                    if($RStatus=='ON'){
                        include("dbConnect.php");
                        $sql = "select * from candidate2nd where approve_status=1";
                ...
                <a href="SavedData2.php"><img class="card-img-top" src="<?php echo "img/".$row1['photo'];
                ...
                <div class="card-body">
                        ...
                        <h2 class="card-title"> <a href="SavedData2.php?Party=<?php echo $row1['name']; ?>" class="btn btn-primary">Vote</a></h2>
                </div>
            </div>
        </div>
    </div>
