...
<head>
    ...
    <title>Education Minister Candidates</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <section style="padding-top:50px; padding-bottom:50px">
        <div class="container">
            ...
            $sql="select * from candidate2nd order by id desc";
...
?>
                            ...
                            <td><?php 
                                ...
                                echo '<a href="change_status_2nd.php?id='.$row['id'].'&status=1"
                                    class="btn btn-success">Approve</a>';
                                }else if($row['approve_status']==1){
                                echo '<a href="change_status_2nd.php?id='.$row['id'].'&status=2"
