...
<head>
    ...
    <title>Result(EducationMinister)</title>
    <!--google fonts-->
...
$select = "select MAX(Votess)as MAX from candidate2nd";
$run = mysqli_query($connect, $select);
        ...
        if($rVotess>0){
            ...
            <table class="table table-hover">
                ...
                <?php
                $select = "select * from candidate2nd where Votess='$rVotess'";
                $run = mysqli_query($connect, $select);
                $s = 0;
